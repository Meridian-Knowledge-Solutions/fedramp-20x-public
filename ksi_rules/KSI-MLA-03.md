...
PASS Excellent vulnerability management with comprehensive automated response (94%): PASS Security standards foundation: 1/1 Security Hub standards enabled for detection
...
- PASS Active threat analysis: 50 active security findings (0 critical, 29 high)
